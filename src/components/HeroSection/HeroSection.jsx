...
import Homepage_1x_webp from 'images/Homepage_1x_webp.webp'; // 1x версія WebP
import Homepage from 'images/Homepage.jpg';
import Homepage_1x from 'images/Homepage_1x.jpg';
import Homepage_2x from 'images/Homepage_2x.jpg';
...
const HeroSection = () => {
  return (
    <div>
      ...
      <section className={css.section1}>Section 2 Content</section>
      <section className={css.section2}>Section 3 Content</section>
    </div>
  );
};
